...
public class ModArmorHelm extends ModDraggable {
	...
	public void render() {
		if(this.pos != null) {
			...
			renderItemStack(mc.thePlayer.inventory.armorInventory[3], pos.getAbsoluteX() + 1, pos.getAbsoluteY() + 1);
 		} else {
	...
	@Override
	public void save() {
		File config = new File("config/hud/armorHelm.txt");
