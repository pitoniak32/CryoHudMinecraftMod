...
public class ModArmorChest extends ModDraggable {
	
	private String modName;
	private ScreenPosition pos;
	private boolean enabled;
	
	public ModArmorChest() {
		this.modName = "Chestplate Hud";
	}
	...
	public void render() {
		if(this.pos != null) {
			...
			renderItemStack(mc.thePlayer.inventory.armorInventory[2], pos.getAbsoluteX() + 1, pos.getAbsoluteY() + 1);
 		} else {
	...
	@Override
	public void save() {
		File config = new File("config/hud/armorChest.txt");
