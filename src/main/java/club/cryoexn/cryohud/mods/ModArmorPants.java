...
public class ModArmorPants extends ModDraggable {
	
	private String modName;
	private ScreenPosition pos;
	private boolean enabled;
	
	public ModArmorPants() {
		this.modName = "Pants Hud";
	}
	...
	public void render() {
		if(this.pos != null) {
			...
			renderItemStack(mc.thePlayer.inventory.armorInventory[1], pos.getAbsoluteX() + 1, pos.getAbsoluteY() + 1);
 		} else {
	...
	@Override
	public void save() {
		File config = new File("config/hud/armorPants.txt");
