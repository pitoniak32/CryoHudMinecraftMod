...
public class GuiHudMainMenu extends GuiScreen {
	...
	private final String TITLE = EnumChatFormatting.BOLD + "" + 
								 EnumChatFormatting.AQUA + "*" +  
								 EnumChatFormatting.BOLD +
								 EnumChatFormatting.DARK_AQUA + " CryoHud " + 
								 EnumChatFormatting.BOLD +
								 EnumChatFormatting.AQUA + "*";
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(ID_POSITIONS, btnsPos.getAbsoluteX(), btnsPos.getAbsoluteY() - BTN_HEIGHT * 3, BTN_WIDTH , BTN_HEIGHT, "Positions"));
		this.buttonList.add(new GuiButton(ID_STATUS, btnsPos.getAbsoluteX(), btnsPos.getAbsoluteY() + SPACING - BTN_HEIGHT * 2, BTN_WIDTH, BTN_HEIGHT, "Mod Settings"));
	}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.fontRendererObj.drawString(TITLE, posTitle.getAbsoluteX(), posTitle.getAbsoluteY(), 0xffffff);
		
		this.drawHollowRect(posBorder.getAbsoluteX() - 7, posBorder.getAbsoluteY() + 3, BTN_WIDTH + 13, (BTN_HEIGHT + SPACING) * 3, 0x24ffffff);
